...
export default function Quizcategory(){
    ...
    return(
        ...
        <div className="flex lg:flex-row flex-col  justify-center gap-[40px] ">
            <Link to="/science"><button className="bg-black text-gray-300 text-center  rounded px-[50px] py-[25px]   font-bold text-[180%]">Science</button></Link>
            <Link to="/sports"><button className="bg-black text-gray-300 text-center  rounded px-[50px] py-[25px]   font-bold text-[180%]">Sports</button></Link>
            <Link to="/bollywood"><button className="bg-black text-gray-300 text-center  rounded px-[50px] py-[25px]   font-bold text-[180%]">Bollywood</button>
            </Link>
        </div>
        </div>
        </div>
